...
INSERT INTO public.moves AS "inkling"
  ...
  VALUES
    (12, 'jab 1', 'single', 'move'),
    (12, 'jab 2', 'single', 'move'),
    (12, 'jab 3', 'single', 'move'),
    (12, 'rapid jab', 'multi', 'move'),
    (12, 'rapid jab finisher', 'single', 'move'),
    (12, 'forward tilt', 'single', 'move'),
    (12, 'up tilt', 'single', 'move'),
    (12, 'down tilt', 'first/second', 'move'),
    (12, 'dash attack', 'early/late', 'move'),
    (12, 'forward smash', 'close/sweet', 'move'),
    (12, 'up smash', 'first/close/far', 'move'),
    (12, 'down smash', '(front)(back)', 'move'),
    (12, 'neutral air', 'single', 'move'),
    (12, 'forward air', 'sweet/early/late', 'move'),
    (12, 'back air', 'sweet/close', 'move'),
    (12, 'up air', 'first/second', 'move'),
    (12, 'down air', 'sweet/close', 'move'),
    (12, 'neutral b', 'multi', 'move'),
    (12, 'side b', 'air/grounded', 'move'),
    (12, 'up b', 'grounded/air/landing', 'move'),
    (12, 'down b', 'charge', 'move');

INSERT INTO public.moves AS "joker"
  ("fighterId", "name", "moveType", "type")
  VALUES
    (13, 'jab 1', 'single (arsene)', 'move'),
    (13, 'jab 2', 'single (arsene)', 'move'),
    (13, 'jab 3', 'single (arsene)', 'move'),
    (13, 'forward tilt', 'first/second (arsene)', 'move'),
    (13, 'up tilt', 'first/multi/final', 'move'),
    (13, 'down tilt', 'late/early', 'move'),
    (13, 'dash attack', 'first/second', 'move'),
    (13, 'forward smash', 'single', 'move'),
    (13, 'up smash', 'single', 'move'),
    (13, 'down smash', 'front/back', 'move'),
    (13, 'neutral air', 'single (front/back)', 'move'),
    (13, 'forward air', 'first/second', 'move'),
    (13, 'back air', 'single', 'move'),
    (13, 'up air', 'multi/final', 'move'),
    (13, 'down air', 'single (Arsene: first/second', 'move'),
    (13, 'neutral b', 'close/med/far', 'move'),
    (13, 'side b', 'contact/erupt', 'move'),
    (13, 'side b, arsene', 'contact/erupt', 'move'),
    (13, 'up b (grappling hook)', 'recovery', 'move'),
    (13, 'up b (grappling attack)', 'grounded/air', 'move'),
    (13, 'down b, rebel''s guard', 'minimal/additional endlag', 'move'),
    (13, 'down b, counterattack', 'counter', 'move'),
    (13, 'down b, arsene', 'multiplier (minimum/maximum)', 'move');
