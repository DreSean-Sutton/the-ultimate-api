...
INSERT INTO public.moves AS "inkling"
  ...
  VALUES
    ...
    (7, 'jab 3', 'single'),
    (7, 'rapid jab', 'multi'),
    (7, 'rapid jab finisher', 'single'),
    (7, 'forward tilt', 'single'),
    (7, 'up tilt', 'single'),
    (7, 'down tilt', 'first/second'),
    (7, 'dash attack', 'early/late'),
    (7, 'forward smash', 'close/sweet'),
    (7, 'up smash', 'first/close/far'),
    (7, 'down smash', '(front)(back)'),
    (7, 'neutral air', 'single'),
    (7, 'forward air', 'sweet/early/late'),
    (7, 'back air', 'sweet/close'),
    (7, 'up air', 'first/second'),
    (7, 'down air', 'sweet/close'),
    (7, 'neutral b', 'multi'),
    (7, 'side b', 'air/grounded'),
    (7, 'up b', 'grounded/air/landing'),
    (7, 'down b', 'charge');

INSERT INTO public.moves AS "joker"
  ("fighterId", "name", "moveType")
  VALUES
    (8, 'jab 1', 'single (arsene)'),
    (8, 'jab 2', 'single (arsene)'),
    (8, 'jab 3', 'single (arsene)'),
    (8, 'rapid jab', null),
    (8, 'rapid jab finisher', null),
    (8, 'forward tilt', 'first/second (arsene)'),
    (8, 'up tilt', 'first/multi/final'),
    (8, 'down tilt', 'late/early'),
    (8, 'dash attack', 'first/second'),
    (8, 'forward smash', 'single'),
    (8, 'up smash', 'single'),
    (8, 'down smash', 'front/back'),
    (8, 'neutral air', 'single (front/back)'),
    (8, 'forward air', 'first/second'),
    (8, 'back air', 'single'),
    (8, 'up air', 'multi/final'),
    (8, 'down air', 'single (Arsene: first/second'),
    (8, 'neutral b', 'close/med/far'),
    (8, 'side b', 'contact/erupt'),
    (8, 'side b, arsene', 'contact/erupt'),
    (8, 'up b (grappling hook)', 'recovery'),
    (8, 'up b (grappling attack)', 'grounded/air'),
    (8, 'down b, rebel''s guard', 'minimal/additional endlag'),
    (8, 'down b, counterattack', 'counter'),
    (8, 'down b, arsene', 'multiplier (minimum/maximum)');
