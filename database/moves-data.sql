...
INSERT INTO public.moves AS "inkling"
  ...
  VALUES
    ...
    (10, 'jab 3', 'single'),
    (10, 'rapid jab', 'multi'),
    (10, 'rapid jab finisher', 'single'),
    (10, 'forward tilt', 'single'),
    (10, 'up tilt', 'single'),
    (10, 'down tilt', 'first/second'),
    (10, 'dash attack', 'early/late'),
    (10, 'forward smash', 'close/sweet'),
    (10, 'up smash', 'first/close/far'),
    (10, 'down smash', '(front)(back)'),
    (10, 'neutral air', 'single'),
    (10, 'forward air', 'sweet/early/late'),
    (10, 'back air', 'sweet/close'),
    (10, 'up air', 'first/second'),
    (10, 'down air', 'sweet/close'),
    (10, 'neutral b', 'multi'),
    (10, 'side b', 'air/grounded'),
    (10, 'up b', 'grounded/air/landing'),
    (10, 'down b', 'charge');

INSERT INTO public.moves AS "joker"
  ("fighterId", "name", "moveType")
  VALUES
    (11, 'jab 1', 'single (arsene)'),
    (11, 'jab 2', 'single (arsene)'),
    (11, 'jab 3', 'single (arsene)'),
    (11, 'forward tilt', 'first/second (arsene)'),
    (11, 'up tilt', 'first/multi/final'),
    (11, 'down tilt', 'late/early'),
    (11, 'dash attack', 'first/second'),
    (11, 'forward smash', 'single'),
    (11, 'up smash', 'single'),
    (11, 'down smash', 'front/back'),
    (11, 'neutral air', 'single (front/back)'),
    (11, 'forward air', 'first/second'),
    (11, 'back air', 'single'),
    (11, 'up air', 'multi/final'),
    (11, 'down air', 'single (Arsene: first/second'),
    (11, 'neutral b', 'close/med/far'),
    (11, 'side b', 'contact/erupt'),
    (11, 'side b, arsene', 'contact/erupt'),
    (11, 'up b (grappling hook)', 'recovery'),
    (11, 'up b (grappling attack)', 'grounded/air'),
    (11, 'down b, rebel''s guard', 'minimal/additional endlag'),
    (11, 'down b, counterattack', 'counter'),
    (11, 'down b, arsene', 'multiplier (minimum/maximum)');
