...
INSERT INTO public.moves AS "inkling"
  ...
  VALUES
    ...
    (9, 'up tilt', 'single'),
    (9, 'down tilt', 'first/second'),
    (9, 'dash attack', 'early/late'),
    (9, 'forward smash', 'close/sweet'),
    (9, 'up smash', 'first/close/far'),
    (9, 'down smash', '(front)(back)'),
    (9, 'neutral air', 'single'),
    (9, 'forward air', 'sweet/early/late'),
    (9, 'back air', 'sweet/close'),
    (9, 'up air', 'first/second'),
    (9, 'down air', 'sweet/close'),
    (9, 'neutral b', 'multi'),
    (9, 'side b', 'air/grounded'),
    (9, 'up b', 'grounded/air/landing'),
    (9, 'down b', 'charge');

INSERT INTO public.moves AS "joker"
  ("fighterId", "name", "moveType")
  VALUES
    (10, 'jab 1', 'single (arsene)'),
    (10, 'jab 2', 'single (arsene)'),
    (10, 'jab 3', 'single (arsene)'),
    (10, 'forward tilt', 'first/second (arsene)'),
    (10, 'up tilt', 'first/multi/final'),
    (10, 'down tilt', 'late/early'),
    (10, 'dash attack', 'first/second'),
    (10, 'forward smash', 'single'),
    (10, 'up smash', 'single'),
    (10, 'down smash', 'front/back'),
    (10, 'neutral air', 'single (front/back)'),
    (10, 'forward air', 'first/second'),
    (10, 'back air', 'single'),
    (10, 'up air', 'multi/final'),
    (10, 'down air', 'single (Arsene: first/second'),
    (10, 'neutral b', 'close/med/far'),
    (10, 'side b', 'contact/erupt'),
    (10, 'side b, arsene', 'contact/erupt'),
    (10, 'up b (grappling hook)', 'recovery'),
    (10, 'up b (grappling attack)', 'grounded/air'),
    (10, 'down b, rebel''s guard', 'minimal/additional endlag'),
    (10, 'down b, counterattack', 'counter'),
    (10, 'down b, arsene', 'multiplier (minimum/maximum)');
