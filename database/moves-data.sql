...
INSERT INTO public.moves AS "joker"
  ("fighterId", "name", "moveType", "type")
  VALUES
    (27, 'jab 1', 'single (arsene)', 'move'),
    (27, 'jab 2', 'single (arsene)', 'move'),
    (27, 'jab 3', 'single (arsene)', 'move'),
    (27, 'forward tilt', 'first/second (arsene)', 'move'),
    (27, 'up tilt', 'first/multi/final', 'move'),
    (27, 'down tilt', 'late/early', 'move'),
    (27, 'dash attack', 'first/second', 'move'),
    (27, 'forward smash', 'single', 'move'),
    (27, 'up smash', 'single', 'move'),
    (27, 'down smash', 'front/back', 'move'),
    (27, 'neutral air', 'single (front/back)', 'move'),
    (27, 'forward air', 'first/second', 'move'),
    (27, 'back air', 'single', 'move'),
    (27, 'up air', 'multi/final', 'move'),
    (27, 'down air', 'single (Arsene: first/second', 'move'),
    (27, 'neutral b', 'close/med/far', 'move'),
    (27, 'side b', 'contact/erupt', 'move'),
    (27, 'side b, arsene', 'contact/erupt', 'move'),
    (27, 'up b (grappling hook)', 'recovery', 'move'),
    (27, 'up b (grappling attack)', 'grounded/air', 'move'),
    (27, 'down b, rebel''s guard', 'minimal/additional endlag', 'move'),
    (27, 'down b, counterattack', 'counter', 'move'),
    (27, 'down b, arsene', 'multiplier (minimum/maximum)', 'move');
