...
INSERT INTO public.grappling AS "kazuya"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '7-8', '39'),
    (null, '9-10', '43'),
    (null, '10-11', '43'),
    (null, '7-8', '36'),
    ('10.0/13.0/1.0%', '32/80/81', '104'),
    ('3.4%', '5', '33'),
    ('5.0/5.0/2.0%', '11/39/42', '75'),
    ('14.0%', '46', '83'),
    ('2.0/10.0%', '14', '65'),
    ('7.0/1.0%', '34/35', '54');
...
INSERT INTO public.grappling AS "kirby"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '6-7', '34'),
    (null, '9-10', '41'),
    ...
    ('8.0%', '41', '48'),
    ('10.0%', '58', '86'),
    ('1.0% (9 hits)/2.0% (final)', '9-10/13-14/17-18/21-22/25-26/29-30/33-34/37-38/41-42/56-57', '87');

INSERT INTO public.grappling AS "link"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '6-7', '34'),
    (null, '9-10', '42'),
...
INSERT INTO public.grappling AS "littleMac"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '9-10', '38'),
    (null, '13-14', '46'),
...
INSERT INTO public.grappling AS "lucario"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '7-8', '39'),
    (null, '10-11', '46'),
    (null, '11-12', '42'),
    ('0.8 | 1.3 | 2.0%', '1', '19 | 20 | 21'),
    ('3.3/1.9 | 5.0/3.0 | 8.0/4.8%', '6/7', '21'),
    ('6.6 | 10.0 | 16/0%', '14', '35'),
    ('3.3/3.9 | 5.0/6.0 | 8.0/9.6%', '16/17', '37'),
    ('4.6 | 7.0 | 11.2%', '28', '50');

INSERT INTO public.grappling AS "lucas"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '12-17', '46'),
    (null, '14-19', '54'),
...
INSERT INTO public.grappling AS "luigi"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '14-20', '47'),
    (null, '16-22', '51'),
...
INSERT INTO public.grappling AS "mario"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '6-7', '34'),
    (null, '9-10', '42'),
...
INSERT INTO public.grappling AS "metaKnight"
  ...
  VALUES
    ...
    ('7.0/3.0%', '16/18', '34'),
    ('10.0%', '46', '77'),
    ('0.5/1.0/2.0%', '11-55 (hit: 8)/59-61/73-74', '86');

INSERT INTO public.grappling AS "mewtwo"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '7-8', '39'),
    (null, '10-11', '47'),
    (null, '11-12', '42'),
    ('1.3%', '1', '19'),
    ('3.0/2.0(x5)%', '19/33/40/47/54/61', '81'),
    ('10.0%', '30', '54'),
    ('12.0%', '43', '79'),
    ('4.0/5.0%', '16/18', '41');
...
INSERT INTO public.grappling AS "ness"
  ...
  VALUES
    ...
    ('11.0%', '27', '52'),
    ('12.0%', '36', '55'),
    ('0.5/0.5/0.5/1.5/4.0%', '6-9/10-13/14-17/26-29', '50');
...
INSERT INTO public.grappling AS "olimar"
  ...
  VALUES
    ...
    (null, '12-23', '41/47/56'),
    ('1.3%', '1', '16'),
    ('5.6/7.0/11.9/7.0/7.0%', '19', '35'),
    ('7.2/9.0/15.3/9.0/9.0%', '22', '39'),
    ('6.4/8.0/13.5/8.0/8.0%', '22/23', '49'),
    ('6.6/8.0/12.9/7.8/8.6%', '23/32', '41');
...
INSERT INTO public.grappling AS "pichu"
  ...
  VALUES
    ...
    (null, '8-9', '39'),
    (null, '9-10', '36'),
    ('1.4% | 0.1% self-dmg |', '1', '18'),
    ('1.5/1.5/1.5/1.5/6.0%', '11/15/19/23/27', '43'),
    ('9.0%', '26', '49'),
    ('5.0/5.0%', '14/15', '35'),
    ('4.0/4.0%', '14/19', '39');
...
INSERT INTO public.grappling AS "pikachu"
  ...
  VALUES
    ...
    (null, '12-13', '39'),
    ('1.0%', '1', '16'),
    ('2.0/2.0/2.0/2.0/2.0%', '11/15/19/23/30', '43'),
    ('9.0%', '26', '49'),
    ('3.0/5.0%', '14/16', '35'),
    ('5.0%', '29', '51');
...
INSERT INTO public.grappling AS "rosalinaAndLuma"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '6-7', '39'),
    (null, '9-10', '46'),
...
INSERT INTO public.grappling AS "sonic"
  ...
  VALUES
    ...
    ('7.0%', '43', '66'),
    ('1.0/5.0%', '22/23', '42'),
    ('1.0/1.0/1.0/5.0%', '18/26/34/42', '74');
...
INSERT INTO public.grappling AS "wario"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '8010', '35'),
    (null, '11-13', '43'),
...
INSERT INTO public.grappling AS "wiiFit"
  ("damage", "activeFrames", "totalFrames")
  VALUES
    (null, '6-7', '34'),
    (null, '9-10', '42'),
...
INSERT INTO public.grappling AS "zelda"
  ...
  VALUES
    ...
    ('12.0%', '27', '49'),
    ('11.0%', '30', '49'),
    ('1.5/1.5/1.5/1.5/2.0%', '25/30/35/39/42', '61');
